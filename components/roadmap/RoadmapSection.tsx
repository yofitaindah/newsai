                ...
                <ul className="timeline-with-icons">
                    <li className="timeline-item mb-5">
                        ...
                        <p className="text-muted">
                            <ul>
                                <li>
                                    Build core features: news aggregation, sentiment analysis, and
                                    real-time alerts
                                </li>
                    ...
                    <li className="timeline-item mb-5">
                        ...
                        <p className="text-muted">
                            <ul>
                                <li>
                                    Implement advanced NLP models for summarization and context
                                    understanding
                                </li>
                                <li>
                                    Introduce recommendation engines. Auditing $NXAI to increase
                                    holder trust
                                </li>
                                <li>
                                    Accelerating community expansion through user engagement
                                    marketing campaigns
                                </li>
                            </ul>
                        </p>
                    ...
                    <li className="timeline-item mb-5">
                        ...
                        <p className="text-muted">
                            <ul>
                                ...
                                <li>
                                    Fixing bugs and adjusting the platform based on beta user
                                    feedback
                                </li>
                            </ul>
                        </p>
